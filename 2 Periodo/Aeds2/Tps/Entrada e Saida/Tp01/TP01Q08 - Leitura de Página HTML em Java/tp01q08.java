...
class tp01q08 {
    ...
    public static int Consoantes(String html) {
        ...
        for (int i = 0; i < html.length(); i++) {
            ...
            if (html.charAt(i) == 'b' || html.charAt(i) == 'c' || html.charAt(i) == 'd' || html.charAt(i) == 'f'
                    || html.charAt(i) == 'g' || html.charAt(i) == 'h' || html.charAt(i) == 'j' || html.charAt(i) == 'k'
                    || html.charAt(i) == 'l' || html.charAt(i) == 'm' || html.charAt(i) == 'n' || html.charAt(i) == 'p'
                    || html.charAt(i) == 'q' || html.charAt(i) == 'r' || html.charAt(i) == 's' || html.charAt(i) == 't'
                    || html.charAt(i) == 'v' || html.charAt(i) == 'w' || html.charAt(i) == 'x' || html.charAt(i) == 'y'
                    || html.charAt(i) == 'z') {
                cont++;
            }
        }
    ...
    public static int isBr(String html) {
        int cont=0;
    if (html.charAt(0) == '<' && html.charAt(1) == 'b' && html.charAt(2) == 'r'&& html.charAt(3) == '>'){
        cont ++;
    }
    return cont;
}
    public static int isTable(String html) {
        int cont=0;
    for (int i = 0; i < html.length(); i++) {
        if (html.charAt(0) == '<' && html.charAt(1) == 't' && html.charAt(2) == 'a' && html.charAt(3) == 'b' && html.charAt(4) == 'l' && html.charAt(5) == 'e' && html.charAt(6) == '>' ){
        cont ++;
    }
}
    return cont;
