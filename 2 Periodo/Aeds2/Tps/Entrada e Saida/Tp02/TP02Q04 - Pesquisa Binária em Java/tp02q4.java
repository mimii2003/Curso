...
class CCelula2 {
    ...
    public CCelula2( Serie3 valorItem, CCelula2 proxCelula)
    {
        item = valorItem;
        prox = proxCelula;
    }    			
    public CCelula2( Serie3 valorItem)
    {
        item = valorItem;
        prox = null;
    }    			        	
...
class  Serie3{
    ...
    public  Serie3(String name, String format, String duration, String country, String language, String broadcaster, String streaming, int seasons, 
    int episodes){
        this.name = name;
        this.format = format;
...
public class tp02q4 {
    ...
    public static int Pesquisa(Serie3[] serie, String x, int i){
        int inicio = 0, fim = i;
        // enquanto inicio for maior que fim fazer
        while (inicio >= 0 && inicio <= fim) {
            // comeca comparando da metade, se retornar -1 nao esta presente no vetor
            int meio = inicio + (fim - inicio) / 2;
            int res = serie[meio].getName().compareTo(x);
