...
class Lista3{
    ...
    public void empilhar(Serie6 elemento) throws Exception {
        while(!f1.isVazia()){
...
class Fila {
     ...
     */
    public void inserir(Serie6 x) throws Exception {
     ...
     */
    public Serie6 remover() throws Exception {
