...
class Lista3 {
    ...
    public void intercalar(int esq, int meio, int dir){
        ...
        Serie6[] a1 = new Serie6[n1+1];
        Serie6[] a2 = new Serie6[n2+1];
        ...
        Serie6 aux = new Serie6();
        a1[i] = a2[j] = aux;
        aux.setEpisodes(0x7FFFFFFF);
        //Intercalacao propriamente dita
        for(i = j = 0, k = esq; k <= dir; k++){
            movimentacoes++;
            comparacoes++;
            array[k] = ((a2[j].getEpisodes() > a1[i].getEpisodes())|| 
            ((a2[j].getEpisodes() == a1[i].getEpisodes()) && 
            (a2[j].getName().compareTo(a1[i].getName())> 0))) ? a1[i++] : a2[j++];
        }
    }
...
public class tp03q09 {
    ...
    public static void main(String[] args){
        ...
        Arq.close();
        Arq.openRead("matricula_mergesort.txt");
    }
}